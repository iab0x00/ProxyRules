...
> ⚠️ 未经允许禁止转载与传播，由此产生的一切后果自负，与本仓库无关  
...
- **恢复默认**：设置 → 颜色 → 重设颜色  
- **配色方案**：[点击跳转 LOWERTOP 颜色配置](https://github.com/LOWERTOP/Shadowrocket-First?tab=readme-ov-file#shadowrocket-配色文件)
...
> 使用说明：规则类型请选择 `RULE-SET`

| 名称 | 链接 |
|------|------|
| 🍎 Apple 智能 | [长按复制规则链接](https://raw.githubusercontent.com/iab0x00/ProxyRules/main/Rule/AppleIntelligence.txt) |
| 🤖 AI 合集 | [长按复制规则链接](https://raw.githubusercontent.com/iab0x00/ProxyRules/main/Rule/AI.txt) |
...
| ☎️ Talkatone | [长按复制规则链接](https://raw.githubusercontent.com/iab0x00/ProxyRules/main/Rule/Talkatone.txt) |
